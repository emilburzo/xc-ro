...
function SortHeader({ col, label, align, activeSort, activeDir, onSort }: { col: string; label: string; align?: "right"; activeSort?: string; activeDir?: string; onSort: (col: string) => void }) {
  return (
    <th
